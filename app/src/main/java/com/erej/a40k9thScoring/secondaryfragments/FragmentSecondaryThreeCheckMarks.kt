...
class FragmentSecondaryThreeCheckMarks(private val battleObject: Battle, private val objective: Objective, private var secondaryCounter: Int, private val counterNumber: Int) : Fragment(
    ...
    private fun updateVP (){
        battleObject.secondaryToVpThreeCheckMarks(objective, counterNumber, secondaryCounter, secondaryCounter2, secondaryCounter3)
